    ...
    public class MeshEditor : UnityEditor.Editor
    {
        ...
        void UpdateVertexEditing()
        {
            ...
            foreach (var vert in vertexSelection)
            {
                ...
                Handles.CubeHandleCap(1, editObject.ppMesh.GetVertexByIndexWorld(vert), Quaternion.identity, handleSize, EventType.Used);
            }
            ...
            if (!handleSelected && vertex != -1 && hoverPoint && !vertexSelection.Contains(vertex))
            {
                ...
                Handles.CubeHandleCap(1, editObject.ppMesh.GetVertexByIndexWorld(vertex), Quaternion.identity, handleSize, EventType.Used);
            }
        }
        ...
        private void UpdatePolygonEditing()
        {
            ...
            if (!handleSelected)
            {
                if (guiEvent == EventType.MouseUp)
                {
                    ...
                    editObject.ppMesh.StartUpdateFacesDelta(faceSelection, true);
        ...
        void UpdateEdgesEditing()
        {
            ...
            if (!handleSelected)
            {
                ...
                {
                    oldDragPos = editObject.ppMesh.GetAveragePos(array);
                    editObject.ppMesh.StartUpdateEdgesDelta(edgeSelection, true);
