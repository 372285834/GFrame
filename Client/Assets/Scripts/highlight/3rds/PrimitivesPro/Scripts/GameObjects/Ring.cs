...
namespace PrimitivesPro.GameObjects
{
    ...
    public class Ring : BaseObject
    {
        ...
        public static Ring Create(float radius0, float radius1, int segments, float angle)
        {
            ...
            ring.GenerateGeometry(radius0, radius1, segments, angle);
        ...
        /// <param name="segments">number of segments</param>
        public void GenerateGeometry(float radius0, float radius1, int segments, float angle)
        {
            ...
            // generate geometry
            GenerationTimeMS = Primitives.RingPrimitive.GenerateGeometry(mesh, radius0, radius1, segments, angle);
            this.angle = angle;
        ...
        {
            GenerateGeometry(radius0, radius1, segments,angle);
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider)
            {
                ...
                Primitives.RingPrimitive.GenerateGeometry(meshCollider, radius0, radius1, segments, angle);
