...
namespace PrimitivesPro.GameObjects
{
    ...
    public class Ellipse : BaseObject
    {
        ...
        public void GenerateGeometry(float radius0, float radius1, int segments)
        {
            ...
            // generate geometry
            GenerationTimeMS = Primitives.EllipsePrimitive.GenerateGeometry(mesh, radius0, radius1, segments,360);
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider)
            {
                ...
                Primitives.EllipsePrimitive.GenerateGeometry(meshCollider, radius0, radius1, segments,360);
