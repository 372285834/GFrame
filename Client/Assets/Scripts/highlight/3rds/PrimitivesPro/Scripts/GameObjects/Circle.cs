...
namespace PrimitivesPro.GameObjects
{
    ...
    public class Circle : BaseObject
    {
        ...
        public static Circle Create(float radius, int segments, float angle)
        {
            ...
            circle.GenerateGeometry(radius, segments, angle);
        ...
        /// <param name="radius">radius of circle</param>
        /// <param name="segments">number of segments</param>
        public void GenerateGeometry(float radius, int segments, float angle)
        {
            ...
            // generate geometry
            GenerationTimeMS = Primitives.EllipsePrimitive.GenerateGeometry(mesh, radius, radius, segments, angle);
            this.angle = angle;
            this.radius = radius;
        ...
        {
            GenerateGeometry(radius, segments, angle);
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider)
            {
                ...
                Primitives.EllipsePrimitive.GenerateGeometry(meshCollider, radius, radius, segments, angle);
