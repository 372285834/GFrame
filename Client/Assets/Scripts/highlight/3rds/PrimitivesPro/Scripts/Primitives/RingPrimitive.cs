...
namespace PrimitivesPro.Primitives
{
    ...
    public class RingPrimitive : Primitive
    {
        ...
        public static float GenerateGeometry(Mesh mesh, float radius0, float radius1, int segments,float _angle)
        {
            ...
            // generate vertices
            var vertIndex = 0;
            float Deg = _angle / Mathf.Rad2Deg;
            for (int i = 0; i < segments; i++)
            {
                var angle = (float)i / segments * Deg;
