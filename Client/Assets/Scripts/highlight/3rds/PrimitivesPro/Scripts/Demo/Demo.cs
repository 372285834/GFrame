...
internal class Demo : MonoBehaviour
{
    ...
    public void OnButtonHit(int id)
    {
        ...
        switch (id)
        {
            ...
            case 2:
                shapeObject = PrimitivesPro.GameObjects.Circle.Create(1.0f, 3,360);
            ...
            case 4:
                shapeObject = PrimitivesPro.GameObjects.Ring.Create(0.5f, 1.0f, 3,360);
        ...
        if (shapeMain != null)
        {
            ...
            if (animTimeout > 0)
            {
                ...
                switch (shapeID)
                {
                    ...
                    case 2:
                        ((PrimitivesPro.GameObjects.Circle)shapeMain).GenerateGeometry(shapeParams[0], (int)shapeParams[1],360);
                        break;
                    ...
                    case 4:
                        ((PrimitivesPro.GameObjects.Ring)shapeMain).GenerateGeometry(shapeParams[0], shapeParams[1], (int)shapeParams[2],360);
                        break;
