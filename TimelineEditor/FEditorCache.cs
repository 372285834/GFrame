...
//				}
		...
		public void Remove( FEditor editor )
		{
			if( _editorHash == null )
				Refresh();
			_editorHash.Remove( editor.GetRuntimeObject().GetInstanceID() );
			_editorHashKeys.Remove( editor.GetRuntimeObject().GetInstanceID() );
		...
		public void Refresh()
		{
			...
			{
				FObject runtimeObj = _editorHashValues[i] == null ? null : _editorHashValues[i].GetRuntimeObject();
